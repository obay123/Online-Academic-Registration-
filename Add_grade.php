...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_grades_query = "INSERT INTO grades (student_id, grade, course_id) VALUES ('$student_id', '$grade', '$course_id')";
...
<h1>Add Grade for Student ID <?php echo $student_id; ?> - Course ID <?php echo $course_id; ?></h1>

<form method="post" action="Add_grade.php?student_id=<?php echo $student_id; ?>&course_id=<?php echo $course_id; ?>">
